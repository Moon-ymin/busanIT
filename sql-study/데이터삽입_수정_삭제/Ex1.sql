...
- 성별: "F"
- 고용일: "2023-04-01" */
INSERT INTO employees values(500001, '1990-01-01', 'Jamie', 'Reyes', 'F', '2023-04-01');
select * from employees where emp_no = 500001; -- 확인
...
INSERT INTO employees values
	(500002, '1985-02-15', 'Alex', 'Smith','M','2023-04-01'),
...
insert into members (Firstname, lastname, email, membershipdate) values 
	('Alice', 'Johnson', 'alice.johnson@example.com', current_date()),
