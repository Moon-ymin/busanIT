...
class LIfeCycleActivity : AppCompatActivity() {
    ...
    // Acticity 가 실행될 때 : onCreate -> onStart -> onResume
    // Acticity 가 보이지 않을 때 : onPause -> onStop
    // Acticity 가 다시 보일 때 : onRestart -> onStart -> onResume
    // Acticity 가 종료될 때 : onPause -> onStop -> onDestroy
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 액티비티가 관리할 View 를 생성하고 View에 대한 기초작업을 수행
    }
    ...
    override fun onRestart() {
        // onStop 이 호출 된 후 다시 액티비티가 보일 때 호출
        super.onRestart()
