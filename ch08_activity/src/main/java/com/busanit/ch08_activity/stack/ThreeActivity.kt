...
class ThreeActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.run {
            ...
            // FLAG_ACTIVITY_CLEAR_TOP : 지정된 액티비티가 이미 스택에 존재하면, 
            // 그 위의 모든 액티비티를 제거하고 지정한 액티비티를 최상단으로 가져옴
            // 홈 화면으로 바로 돌아갈 때 사용
            oneTextView.setOnClickListener {
                startActivity(
                    Intent(this@ThreeActivity,
                        OneActivity::class.java).apply {
            ...
            threeTextView.setOnClickListener {
                ...
                startActivity(
                    Intent(this@ThreeActivity,
                        ThreeActivity::class.java).apply {
